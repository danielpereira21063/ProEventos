...
namespace ProEventos.API.Controllers
{
    ...
    public class RedesSociaisController : ControllerBase
    {
        ...
        public async Task<IActionResult> SaveByEvento(int eventoId, RedeSocialDto[] models)
        {
            ...
            {
                return StatusCode(StatusCodes.Status400BadRequest, $"Erro ao salvar rede social. \n{ex.Message}");
            }
        }
        ...
        public async Task<IActionResult> GetByPalestrante()
        {
            try
            {
                ...
                var redesSociais = await _redeSocialService.GetAllByPalestranteAsync(palestrante.Id);
            ...
            {
                return StatusCode(StatusCodes.Status500InternalServerError, $"Erro ao tentar recuperar redes sociais. \n{ex.Message}");
            }
        }
